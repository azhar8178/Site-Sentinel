...
- [Deployment identity scope](deployment-identity-scope.md) — deduplicate webhook retries within each system; provider IDs are not globally unique across Magento, Odoo, and other systems.
